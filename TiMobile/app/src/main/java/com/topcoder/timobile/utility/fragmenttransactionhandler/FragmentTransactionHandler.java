package com.topcoder.timobile.utility.fragmenttransactionhandler;

import android.os.Message;
import android.support.v4.app.FragmentActivity;
import com.topcoder.timobile.dialogs.ThemedInfoDialog;

public class FragmentTransactionHandler extends PauseHandler {

  public static final int LOADING_DIALOG_DISMISS_MSG = 100002;
  private static final int SHOW_THEMED_INFO_DIALOG = 100003;
