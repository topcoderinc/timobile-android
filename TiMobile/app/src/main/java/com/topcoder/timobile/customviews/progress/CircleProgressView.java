...
package com.topcoder.timobile.customviews.progress;
...
public class CircleProgressView extends ProgressBar {
   ...
   * 已完成进度条大小
   */
  private int mReachBarSize = AppUtils.dp2px(getContext(), 2);
  /**
   * 未完成进度条大小
   */
  private int mNormalBarSize = AppUtils.dp2px(getContext(), 2);
  /**
   * 已完成进度颜色
   */
   ...
   * 进度值字体大小
   */
  private int mTextSize = AppUtils.sp2px(getContext(), 14);
  /**
   * 进度的值字体颜色
   */
   ...
   * 半径
   */
  private int mRadius = AppUtils.dp2px(getContext(), 20);
  /**
   * 起始角度
   */
   ...
   * 内部圆与外部圆间距
   */
  private int mInnerPadding = AppUtils.dp2px(getContext(), 1);
  /**
   * 外部圆环颜色
   */
   ...
   * 外层圆环宽度
   */
  private int mOuterSize = AppUtils.dp2px(getContext(), 1);
  ...
  public void setReachBarSize(int reachBarSize) {
    mReachBarSize = AppUtils.dp2px(getContext(), reachBarSize);
    invalidate();
  }
  ...
  public void setNormalBarSize(int normalBarSize) {
    mNormalBarSize = AppUtils.dp2px(getContext(), normalBarSize);
    invalidate();
  }
  ...
  public void setTextSize(int textSize) {
    mTextSize = AppUtils.sp2px(getContext(), textSize);
    invalidate();
  }
  ...
  public void setRadius(int radius) {
    mRadius = AppUtils.dp2px(getContext(), radius);
    invalidate();
  }
  ...
  public void setInnerPadding(int innerPadding) {
    mInnerPadding = AppUtils.dp2px(getContext(), innerPadding);
    int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
    rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
    invalidate();
  }
  ...
  public void setOuterSize(int outerSize) {
    mOuterSize = AppUtils.dp2px(getContext(), outerSize);
    invalidate();
  }
