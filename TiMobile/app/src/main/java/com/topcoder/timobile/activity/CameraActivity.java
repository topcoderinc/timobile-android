...
import com.topcoder.timobile.dialogs.AspectRatioFragment;
...
public class CameraActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, AspectRatioFragment.Listener {
  ...
  private View.OnClickListener mOnClickListener = new View.OnClickListener() {
    @Override public void onClick(View v) {
      switch (v.getId()) {
        ...
        case R.id.tvRetake:
          mImgCaptured.setVisibility(View.GONE);
          break;
        case R.id.tvFinish:
          if (isFromProfile) {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mRetakeView = (TextView) findViewById(R.id.tvRetake);
    mFinishView = (TextView) findViewById(R.id.tvFinish);
    isFromProfile = getIntent().getBooleanExtra(AppConstants.KEY_BOOl, false);
    if (mCameraView != null) {
  ...
  private void showImage(File file) {
    runOnUiThread(() -> {
      mImgCaptured.setVisibility(View.VISIBLE);
      GlideApp.with(this).load(file).into(mImgCaptured);
      mFinishView.setVisibility(View.VISIBLE);
      mRetakeView.setVisibility(View.VISIBLE);
    });
  }
  ...
  public static class ConfirmationDialogFragment extends DialogFragment {
    ...
    @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      return new AlertDialog.Builder(getActivity()).setMessage(args.getInt(ARG_MESSAGE)).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
      ...
      }).setNegativeButton(android.R.string.cancel, (dialog, which) -> Toast.makeText(getActivity(), args.getInt(ARG_NOT_GRANTED_MESSAGE), Toast.LENGTH_SHORT).show()).create();
    }
  }
}
